...
# Generate a dummy hash for preventing timing attacks
# We do this at import time so we don't pay the cost on every request,
# but we DO pay the cost when verifying against it.
