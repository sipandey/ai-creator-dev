        ...
        <CardContent className="p-8">
          <form onSubmit={handleSignup} className="space-y-8">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <label htmlFor="email" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 cursor-pointer">Work Email</label>
                <input
                  id="email"
                  type="email"
                  required
              ...
              <div className="space-y-2">
                <label htmlFor="password" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 cursor-pointer">Secure Password</label>
                <input
                  id="password"
                  type="password"
                  required
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3" role="radiogroup" aria-label="Identity Path">
