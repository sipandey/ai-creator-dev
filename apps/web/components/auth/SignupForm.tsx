        ...
        <form onSubmit={handleSignup}>
          <CardContent className="p-8 space-y-8">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <label htmlFor="email-signup" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Work Email</label>
                <input
                  id="email-signup"
                  type="email"
              ...
              <div className="space-y-2">
                <label htmlFor="password-signup" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Secure Password</label>
                <input
                  id="password-signup"
                  type="password"
                  className="w-full h-14 bg-white border-2 border-slate-100 rounded-xl px-6 outline-none focus:border-blue-600 transition-all font-bold text-slate-900"
