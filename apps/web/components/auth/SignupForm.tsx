        ...
        <CardContent className="p-8 space-y-8">
          <form onSubmit={handleSignup} className="space-y-8">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <label htmlFor="signup-email" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Work Email</label>
                <input
                  id="signup-email"
                  type="email"
                  name="email"
              ...
              <div className="space-y-2">
                <label htmlFor="signup-password" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Secure Password</label>
                <input
                  id="signup-password"
                  type="password"
                  name="password"
