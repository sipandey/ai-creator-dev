      ...
      <Card className="border-slate-200 shadow-sm">
        <CardContent className="p-8 space-y-8">
          <form onSubmit={handleSignup} className="space-y-8">
            ...
            <div className="space-y-4" role="radiogroup" aria-labelledby="identity-path-label">
              <span id="identity-path-label" className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 block">Identity Path</span>
            ...
            {error && (
              <div role="alert" className="p-4 bg-red-50 border border-red-100 rounded-xl text-[11px] font-bold text-red-600 animate-in shake duration-300">
                {error}
              </div>
            )}
