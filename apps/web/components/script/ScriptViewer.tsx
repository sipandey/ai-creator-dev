...
export default function ScriptViewer({ script }: { script: Script }) {
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-500">
      ...
      <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-sm border border-slate-800 relative">
        <div className="flex items-center justify-between mb-2">
          ...
          <CopyButton
            ...
            label="Hook"
            variant="ghost"
            className="text-slate-400 hover:text-white hover:bg-slate-800 h-8 w-8 px-0"
            size="sm"
          />
        </div>
      ...
      <section className="space-y-4">
        <Card className="border-blue-100 bg-blue-50/20">
          <div className="p-5 border-b border-slate-100 bg-slate-50 flex items-center justify-between">
            ...
            <CopyButton text={script.audio_script} label="Script" className="h-8 w-8 px-0" />
          </div>
          <div className="p-8">
          ...
          <div className="p-6 space-y-6">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <CopyButton text={script.caption} label="Caption" className="h-8 w-8 px-0 text-slate-400" size="sm" />
              </div>
            ...
            <div className="pt-6 border-t border-slate-200/60 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <CopyButton text={script.cta} label="Call to Action" className="h-8 w-8 px-0 text-slate-400" size="sm" />
              </div>
